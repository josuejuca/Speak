...
<head>
    ...
    <title>Entrar na conta - Speak</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="col-lg-5 col-xl-4 p-12 p-xl-20 position-fixed start-0 top-0 h-screen overflow-y-hidden bg-primary d-none d-lg-flex flex-column">
                ...
                <div class="mt-32 mb-20">
                    ...
                    <p class="text-white text-opacity-75">
                        So não sei o que, mas vamos tentar. Seja o que Deus quiser.
                    </p>
                </div>
                    ...
                    <div class="col-lg-10 col-md-9 col-xl-6 mx-auto ms-xl-0">
                        ...
                        <form>
                            <div class="mb-5">
                                ...
                                <input type="email" placeholder="exemplo@exemplo.com" class="form-control form-control-muted" id="email">
                            </div>
                            <div class="mb-5">
                                <label class="form-label" for="password">Senha</label>
                                <input type="password" placeholder="Senha" class="form-control form-control-muted" id="password" autocomplete="current-password">
                            </div>
                            <div class="mb-5">
                        ...
                        <div class="my-6">
                            ...
                            <a href="cadastro.php" class="text-warning text-sm font-semibold">Criar conta.</a>
                        </div>
                    </div>
                </div>
            </div>
