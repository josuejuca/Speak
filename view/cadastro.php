...
<head>
    ...
    <title>Criar uma nova conta - Speak</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="row">
                    <div class="col-lg-10 col-md-9 col-xl-7 mx-auto">
                        <div class="text-center mb-12">
                            ...
                            <p class="mt-2">Vamos começar a brincadeira.</p>
                        </div>
                        <form name="new_usuario" method="post" action="../controller/server.php">
                            <div class="row mb-5">
                                <div class="col">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="password" class="form-control" id="senha" name="senha" placeholder="Senha" autocomplete="current-password">
                            </div>
                            <div class="mb-5">
                                <div>
                                    <label class="form-label" for="idPerfil">Escolha o perfil</label>
                                    <select class="form-select" id="idPerfil" name="idPerfil" aria-label="Default select example">
                            ...
                            <div class="mb-5">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="check_example">
                                        Ao criar a conta, declaro que li, entendi e aceito os <a href="">Termos de contrato</a> e as <a href="">Políticas de privacidade</a> da Speak
                                    </label>
                                </div>
                            </div>
                            <div class="row ">
                                ...
                                <div class="col-sm-6">
                                    <button type="reset" class="btn btn-primary w-full">Limpar</button>
                                </div>
                            </div>
                        </form>
                        <div class="py-5 text-center">
                            <span class="text-xs text-uppercase font-semibold">OU</span>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                        ...
                        <div class="my-6">
                            ...
                            <a href="login.php" class="text-warning text-sm font-semibold">ENTRAR</a>
                        </div>
                    </div>
                </div>
            </div>
